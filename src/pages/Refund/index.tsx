      ...
      <div className="px-[var(--mobile-side-pad)] pt-4 space-y-5 max-w-3xl mx-auto">
        ...
        <Section icon={<User size={14} />} title="1. Selecciona el cliente">
          {!clientId ? (
              ...
              <div className="max-h-56 overflow-y-auto no-scrollbar space-y-1.5">
                ...
                {filteredClients.map(c => (
                  <button
                    ...
                    className="w-full flex items-center justify-between px-3 py-2.5 rounded-xl bg-surface-sunken border border-[rgb(var(--fg-rgb))]/[0.06] hover:border-brand-primary/40 transition active:scale-[0.98]"
                  >
            ...
            <div className="flex items-center justify-between bg-surface-sunken border border-[rgb(var(--fg-rgb))]/[0.08] rounded-xl px-3 py-2.5">
              <div className="flex items-center gap-2.5">
                    ...
                    <button
                      ...
                      className={`w-full flex items-center justify-between px-3 py-2.5 rounded-xl border transition active:scale-[0.98] ${
                        isActive
                          ...
                          : 'bg-surface-sunken border-[rgb(var(--fg-rgb))]/[0.06] hover:border-[rgb(var(--fg-rgb))]/20'
                      }`}
                    >
