       ...
       <div className="flex flex-col h-[80vh] md:h-[600px] pt-1">
          ...
          <div className="bg-surface-3 border border-white/10 rounded-lg p-4 mb-4 flex justify-between items-center shrink-0">
              ...
              <div className="text-right">
                  <p className="text-[10px] text-zinc-500 font-bold uppercase">Rentabilidad Bruta</p>
                  <p className="text-sm font-mono text-zinc-300">{settings.currency} {formatMoney(stats.totalProfit)}</p>
              </div>
          </div>
              ...
              {['todos', 'verde', 'amarillo', 'rojo'].map((f) => (
                  <button 
                    ...
                    className={`px-4 py-2 rounded-full text-[11px] font-semibold uppercase border transition-all ${
                        ...
                        : 'bg-surface-zinc text-zinc-500 border-white/10 hover:text-white'
                    }`}
                  >
                      {f}
                  </button>
          ...
          <div className="flex-1 overflow-y-auto custom-scrollbar space-y-2 pr-1">
              {filteredData.map((item) => (
                  <motion.div 
                    ...
                    className="bg-surface-zinc border border-white/5 p-4 rounded-lg flex justify-between items-center cursor-pointer hover:bg-surface-3 transition-colors group"
                  >
                      <div className="flex-1 min-w-0">
                          ...
                          <p className="text-[10px] text-zinc-500 truncate">{item.suggestion}</p>
                      </div>
           ...
           {selectedHealth && (
               ...
               >
                   <div className="flex items-center justify-between mb-8">
                       <button onClick={() => setSelectedHealth(null)} className="p-2 bg-white/5 rounded-full text-zinc-400 hover:text-white"><ChevronRight className="rotate-180" size={20} /></button>
                       <h3 className="text-lg font-bold text-white">Detalle de Salud</h3>
                       <div className="w-10" />
                   </div>
                   ...
                   <div className="flex-1 overflow-y-auto custom-scrollbar space-y-6">
                       <div className="text-center">
                           ...
                           <h2 className="text-2xl font-bold text-white mb-1">{selectedHealth.accountEmail}</h2>
                       ...
                       <div className="bg-surface-3 border border-white/10 p-5 rounded-xl">
                           <h4 className="text-zinc-400 text-xs font-semibold uppercase mb-2 flex items-center gap-2">
                       ...
                       <div className="grid grid-cols-2 gap-4">
                           ...
                           <div className="bg-surface-zinc p-4 rounded-lg border border-white/5">
                               <p className="text-[10px] text-zinc-500 font-bold uppercase mb-1">Ocupación</p>
                               <div className="flex items-center gap-2 text-white font-bold">
