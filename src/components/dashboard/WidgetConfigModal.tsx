  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Personalizar Dashboard">
      <div className="flex flex-col gap-6 pt-2 pb-4">
        ...
        {/* Sección Tarjetas */}
        <div>
            <h4 className="text-xs font-semibold text-text-disabled uppercase tracking-wider mb-3 ml-1">Tarjetas Visibles</h4>
              ...
              {cardsOptions.map((opt) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <span className={`text-xs font-medium ${widgets[opt.key] ? 'text-text-primary' : 'text-text-disabled'}`}>
                      {opt.label}
                    </span>
                  </div>
