                ...
                <div className="space-y-5">
                    ...
                    <div>
                        ...
                        <div className="flex gap-3">
                            ...
                            <button onClick={() => fileInputRef.current?.click()} className="w-[52px] h-[52px] rounded-md bg-surface-1 border border-white/10 flex items-center justify-center text-zinc-400 hover:text-white shrink-0 active:scale-90 transition-transform">
                                <Upload size={20} />
                            </button>
                            <input type="file" ref={fileInputRef} onChange={handleImageUpload} className="hidden" accept="image/*" />
                        </div>
                        <p className="text-[10px] text-zinc-500 mt-2 ml-1">Este logo aparecerá en el Portal de Cliente y Recibos.</p>
                        ...
                        {logo && (
                            <div className="mt-4 flex flex-col items-center">
                                ...
                                <span className="text-[9px] font-bold text-zinc-600 mt-2 uppercase tracking-widest">Vista Previa</span>
                            </div>
                        )}
                    </div>
                </div>
