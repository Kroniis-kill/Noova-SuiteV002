...
export const styles = {
  ...
  input: "w-full bg-surface-sunken border border-[rgb(var(--fg-rgb))]/10 rounded-md px-4 h-[52px] text-sm text-text-primary outline-none focus:border-brand-primary/50 transition-all placeholder:text-text-faint font-medium",
