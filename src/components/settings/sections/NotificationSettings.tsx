                ...
                <div className="space-y-3">
                    <div className={styles.toggleContainer}>
                        <div className="flex items-center gap-3">
                            <div className="w-9 h-9 rounded-xl bg-[rgb(var(--fg-rgb))]/5 flex items-center justify-center shrink-0"><Clock size={16} className="text-status-danger-soft" /></div>
                    ...
                    <div className={styles.toggleContainer}>
                        <div className="flex items-center gap-3">
                            <div className="w-9 h-9 rounded-xl bg-[rgb(var(--fg-rgb))]/5 flex items-center justify-center shrink-0"><Briefcase size={16} className="text-status-info-soft" /></div>
                    ...
                    <div className={styles.toggleContainer}>
                        <div className="flex items-center gap-3">
                            <div className="w-9 h-9 rounded-xl bg-[rgb(var(--fg-rgb))]/5 flex items-center justify-center shrink-0"><DollarSign size={16} className="text-status-warning-soft" /></div>
