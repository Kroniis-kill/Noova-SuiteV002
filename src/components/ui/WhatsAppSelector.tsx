      ...
      <div className="pt-2 pb-2">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <button
            ...
            className="h-12 rounded-md bg-gradient-to-r from-brand-primary to-brand-accent text-white font-semibold text-xs shadow-glow transition-all flex items-center justify-center gap-2 active:scale-95 hover:brightness-110"
          >
