    ...
    >
      <AnimatePresence mode="wait">
        <motion.div
          ...
          className="pointer-events-auto relative flex items-center gap-1.5 pl-2 pr-2.5 py-[5px] rounded-full border border-white/[0.08] shadow-[0_10px_30px_-12px_rgba(0,0,0,0.7),inset_0_1px_0_rgba(255,255,255,0.06)] backdrop-blur-2xl"
          style={{
        ...
        >
          {status === 'syncing' && (
            <>
              <span className="relative flex items-center justify-center w-3 h-3">
                <span className="absolute inset-0 rounded-full border-[1.5px] border-white/10" />
                <span className="absolute inset-0 rounded-full border-[1.5px] border-transparent border-t-brand-lime animate-spin" />
              </span>
              <span className="text-[10px] font-semibold tracking-[0.02em] text-white/95">Guardando</span>
            </>
          )}
          ...
          {status === 'saved' && (
            <>
              ...
              <span className="text-[10px] font-semibold tracking-[0.02em] text-white/95">Guardado</span>
            </>
          )}
          ...
          {status === 'offline' && (
            <>
              ...
              <span className="text-[10px] font-semibold tracking-[0.02em] text-white/95">
          ...
          {status === 'error' && (
            <>
              ...
              <span className="text-[10px] font-semibold tracking-[0.02em] text-white/95 max-w-[140px] truncate">
              ...
              <button
                ...
                aria-label="Cerrar"
                className="ml-0.5 w-3.5 h-3.5 rounded-full hover:bg-white/10 text-white/50 flex items-center justify-center transition"
              >
                <X size={8} />
              </button>
            </>
