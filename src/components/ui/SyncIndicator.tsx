        ...
        >
          {status === 'syncing' && (
            <>
              ...
              <span className="text-[10px] font-semibold tracking-[0.02em] text-primary/95">Guardando</span>
            </>
          )}
          ...
          {status === 'saved' && (
            <>
              ...
              <span className="text-[10px] font-semibold tracking-[0.02em] text-primary/95">Guardado</span>
            </>
          )}
          ...
          {status === 'offline' && (
            <>
              ...
              <span className="text-[10px] font-semibold tracking-[0.02em] text-primary/95">
          ...
          {status === 'error' && (
            <>
              ...
              <span className="text-[10px] font-semibold tracking-[0.02em] text-primary/95 max-w-[140px] truncate">
              ...
              <button
                ...
                aria-label="Cerrar"
                className="ml-0.5 w-3.5 h-3.5 rounded-full hover:bg-[rgb(var(--fg-rgb))]/10 text-primary/50 flex items-center justify-center transition"
              >
                <X size={8} />
              </button>
            </>
