       ...
       <div className="flex flex-col items-center text-center pt-2 pb-2">
          ...
          <div className="relative mb-6">
             ...
             <div className="relative w-24 h-24 rounded-2xl bg-gradient-to-br from-status-info to-brand-primary-hi flex items-center justify-center shadow-glow border border-[rgb(var(--fg-rgb))]/10">
                <Bell size={40} className="text-primary fill-white/20" />
             </div>
          ...
          <div className="flex flex-col gap-3 w-full">
             ...
             <button 
               ...
               className="w-full h-[48px] rounded-md bg-[rgb(var(--fg-rgb))]/5 border border-[rgb(var(--fg-rgb))]/10 text-muted font-bold text-[13px] hover:text-primary hover:bg-[rgb(var(--fg-rgb))]/10 transition-all"
             >
                Quizás más tarde
             </button>
          </div>
