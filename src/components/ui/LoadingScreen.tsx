...
const LoadingScreen: React.FC<LoadingScreenProps> = ({ message = "Iniciando..." }) => {
  return (
    <div className="fixed inset-0 z-[9999] flex flex-col items-center justify-center bg-bg text-text-primary font-sans overflow-hidden">
      ...
      >
        ...
        <div className="flex flex-col items-center gap-4">
           <div className="flex flex-col items-center gap-3">
               ...
               <span className="text-[10px] font-semibold text-text-disabled uppercase tracking-widest animate-pulse">
                 {message}
               </span>
           </div>
        </div>
