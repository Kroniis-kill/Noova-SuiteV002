...
const LoadingScreen: React.FC<LoadingScreenProps> = ({ message = "Iniciando..." }) => {
  return (
    <div className="fixed inset-0 z-[9999] flex flex-col items-center justify-center bg-bg text-white font-sans overflow-hidden">
      ...
      >
        ...
        <div className="flex flex-col items-center gap-4">
           <div className="flex flex-col items-center gap-3">
               <div className="w-8 h-8 border-2 border-white/10 border-t-[#6A2CFF] rounded-full animate-spin" />
               <span className="text-[10px] font-semibold text-zinc-500 uppercase tracking-widest animate-pulse">
                 {message}
               </span>
           </div>
        </div>
