          ...
          <div className="fixed inset-0 z-[9999] flex items-end justify-center pointer-events-none">
            ...
            >
                ...
                <div className="flex flex-col items-center mb-6 shrink-0">
                    ...
                    <h3 className="text-2xl font-bold text-primary text-center tracking-tight leading-tight">{client.name}</h3>
                    <div className="flex items-center gap-2 mt-2">
                        <span className="px-3 py-1 bg-[rgb(var(--fg-rgb))]/5 rounded-full text-xs font-mono text-muted border border-[rgb(var(--fg-rgb))]/5">{client.phone}</span>
                ...
                <div className="flex bg-surface-zinc p-1 rounded-md border border-[rgb(var(--fg-rgb))]/10 mb-6 shrink-0">
                    <button onClick={() => setActiveTab('info')} className={`flex-1 py-2.5 rounded-sm text-xs font-semibold transition-all ${activeTab === 'info' ? 'bg-surface-4 text-primary shadow-sm' : 'text-disabled hover:text-primary'}`}>Info</button>
                    <button onClick={() => setActiveTab('purchases')} className={`flex-1 py-2.5 rounded-sm text-xs font-semibold transition-all ${activeTab === 'purchases' ? 'bg-surface-4 text-primary shadow-sm' : 'text-disabled hover:text-primary'}`}>Compras</button>
                    <button onClick={() => setActiveTab('history')} className={`flex-1 py-2.5 rounded-sm text-xs font-semibold transition-all flex items-center justify-center gap-2 ${activeTab === 'history' ? 'bg-surface-4 text-primary shadow-sm' : 'text-disabled hover:text-primary'}`}>Eventos</button>
                </div>
                ...
                <div className="pt-4 mt-auto">
                    <button onClick={onClose} className="w-full py-4 text-disabled text-xs font-semibold uppercase tracking-widest active:text-primary transition-colors">Cerrar</button>
                </div>
