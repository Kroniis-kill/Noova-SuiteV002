    ...
    <div className="px-5 pt-safe mt-6 pb-24 font-sans min-h-screen relative overflow-hidden bg-bg">
       ...
       {((isTrial || (daysRemaining < 5 && !isLifetime)) && !isBlocked) && (
           <motion.button 
             ...
             className="w-full h-12 bg-gradient-to-r from-brand-primary to-brand-accent rounded-md flex items-center justify-between px-6 shadow-glow relative overflow-hidden group mb-8"
           >
       ...
       <div className="space-y-4">
          ...
          <div className="bg-surface-1 border border-[rgb(var(--fg-rgb))]/[0.08] rounded-xl overflow-hidden shadow-sm">
             ...
             <button 
                ...
                className="w-full p-5 flex items-center justify-between active:bg-[rgb(var(--fg-rgb))]/5 transition-colors group"
             >
                 <div className="flex items-center gap-4">
