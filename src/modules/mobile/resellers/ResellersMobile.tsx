    ...
    <div className="min-h-screen pb-32 pt-2 px-4 font-sans text-text-primary relative">
       ...
       <div className="mb-6 relative z-10">
          <div className="bg-surface-1 border border-[rgb(var(--fg-rgb))]/[0.08] rounded-lg p-4 flex items-center justify-between relative overflow-hidden shadow-sm">
              ...
              <p className="text-3xl font-bold text-text-primary tracking-tight relative z-10">{globalStats.totalClients}</p>
          </div>
       </div>
          ...
          <div className="space-y-4 pt-2">
             <div className="bg-status-danger/10 border border-status-danger/20 p-4 rounded-xl flex gap-4 items-start">
                 ...
                 <div>
                     ...
                     <p className="text-text-muted text-xs mt-1 leading-relaxed">El socio <strong>{resellerToDelete?.name}</strong> tiene clientes asociados.</p>
                 </div>
             </div>
